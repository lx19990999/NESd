...
const defaultPortraitConfig = [
  ...
  CircleButtonConfig(x: 0.7, y: 0.18, action: controller1TurboA, label: 'TA'),
  CircleButtonConfig(x: 0.2, y: 0.18, action: controller1TurboB, label: 'TB'),
  RectangleButtonConfig(
    width: 84,
    height: 44,
    x: -0.3,
...
const defaultLandscapeConfig = [
  ...
  CircleButtonConfig(x: 0.85, y: -0.36, action: controller1TurboA, label: 'TA'),
  CircleButtonConfig(x: 0.6, y: -0.36, action: controller1TurboB, label: 'TB'),
  RectangleButtonConfig(
    width: 96,
    height: 44,
    x: -0.6,
